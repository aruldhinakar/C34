...
var blink,eat,sad;
var mute_btn;
var emptystar,onestarimg,twostarimg
var stardisplay
var fr;
...
function preload()
{
 ...
 // twostarimg = loadAnimaton("stars.png")
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   stardisplay.addAnimation("one_star",onestarimg)
   stardisplay.addAnimation("two_star",twostarimg)
  ...
  blower_btn.mouseClicked(airblow)
...
function draw() 
{
  ...
  {
  star2.visible = false
   stardisplay.changeAnimation("two_star")
   }
